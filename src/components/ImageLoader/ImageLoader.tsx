	...
	return (
		<Container className={className}>
			{/* <ContentWrapper>
					src={src}
					alt={alt}
					initial={{ opacity: 0, y: 0, height: 220 }}
					animate={{
        ...
        <StyledImage
          ...
          animate={{
            opacity: isLoading ? 0 : 1,
            y: startSlideAnimation ? -210 : 0,
            height: startSlideAnimation ? 400 : 550,
          }}
          transition={{
            opacity: { duration: 0.5 },
            y: { duration: 1.2, ease: "easeOut" },
            height: { duration: 2.2, ease: "easeOut", delay: 1.2 },
          }}
        />
        <AnimatePresence>
          {showPoem && (
            <PoemOverlay
              ...
              animate={{
                opacity: 1,
                y: startSlideAnimation ? 130 : 20,
              }}
              exit={{ opacity: 0, y: -20 }}
              transition={{
                opacity: { duration: 0.8 },
                y: { duration: 1.2, ease: "easeOut", delay: 1 },
              }}
            >
              <PoemTitle>Guiding Song</PoemTitle>
              <PoemText>
